...
class TypeProduitsControllerTest < ActionController::TestCase
  ...
  test "should create type_produit" do
    assert_difference('TypeProduit.count') do
      post :create, type_produit: { code: @type_produit.code, is_active: @type_produit.is_active, nom: @type_produit.nom }
    end
  ...
  test "should update type_produit" do
    patch :update, id: @type_produit, type_produit: { code: @type_produit.code, is_active: @type_produit.is_active, nom: @type_produit.nom }
    assert_redirected_to type_produit_path(assigns(:type_produit))
  end
